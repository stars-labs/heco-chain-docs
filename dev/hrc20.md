...
contract HRC20Token is Context, IERC20, Ownable {
    ...
    constructor() public {
        _name = "HMax Token"; // 这里填入你的token名称
        _symbol = "HMax"; // 这里填入你的token标识
        _decimals = 18;
        _totalSupply = 100000000000000000000000000; // token的数量
